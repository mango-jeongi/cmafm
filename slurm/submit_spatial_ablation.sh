...
python train.py \
    ...
    --cfg ../cft_engine/models/transformer/yolov5l_cmafm_spatial_only_M3FD.yaml \
    --hyp ../data/hyp.scratch.yaml \
    --epochs 30 \
    --batch-size 8 \
    --workers 8 \
    --project ../runs/ablation_spatial/seed_$SLURM_ARRAY_TASK_ID \
    --name spatial_only_run
